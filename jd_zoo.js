...
let cookiesArr = [];
$.cookie = '';
$.inviteList = [{ ues: 'jd_441027f2a1e0d', secretp: 'ujWhAqRs5O3UsrbpmM7ZUBXR0Hk', inviteId: '', max: false
},{ ues: 'jd_441027f2a1e0d', secretp: 'ujWhAqRs5O3UsrbpmM7ZUBXR0Hk', inviteId: '', max: false
}];
$.pkInviteList = [];
$.secretpInfo = {};
$.innerPkInviteList = [];
...
!(async () => {
  ...
  let res = [], res2 = [], res3 = [];
  res3 = await getAuthorShareCode('https://raw.githubusercontent.com/fxxcl/JDbot/master/shareCodes/pk.json');
  if (!res3) await getAuthorShareCode('fxxcl')
  if (new Date().getUTCHours() + 8 >= 12) {
    res = await getAuthorShareCode() || [];
    res2 = await getAuthorShareCode('https://raw.githubusercontent.com/fxxcl/JDbot/master/shareCodes/pk.json') || [];
  }
  if (pKHelpAuthorFlag) {
